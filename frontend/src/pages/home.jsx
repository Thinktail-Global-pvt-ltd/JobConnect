      ...
      <section className="relative min-h-[100dvh] flex items-center justify-center pt-24 pb-12 px-6">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col items-center text-center">
          ...
          >
            <motion.h1
              variants={fadeUp}
              className="text-6xl md:text-8xl lg:text-9xl font-display font-bold tracking-tight text-white leading-[0.9]"
            >
              Connecting
              <br />
              hospitality
      ...
      <section className="relative min-h-[90dvh] flex items-center py-24 px-6 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.h2
              variants={fadeUp}
              className="text-6xl md:text-8xl font-display font-bold text-white mb-6 leading-[1.0]"
            >
              Opportunities
              <br />
              near you —<br />
      ...
      <section className="relative min-h-[90dvh] flex items-center py-24 px-6 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col items-center text-center">
          ...
          >
            ...
            <motion.h2
              variants={fadeUp}
              className="text-6xl md:text-8xl lg:text-9xl font-display font-bold text-white mb-8 leading-[1.0] max-w-5xl"
            >
