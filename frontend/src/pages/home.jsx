      ...
      <section className="relative min-h-[100dvh] flex items-center justify-center pt-24 pb-12 px-6">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col items-center text-center">
          ...
          >
            <motion.h1
              variants={fadeUp}
              className="text-[2.2rem] sm:text-[4rem] md:text-[5rem] lg:text-[5.5rem] font-display font-bold tracking-tight text-white leading-[1.15] drop-shadow-[0_4px_20px_rgba(0,0,0,0.9)]"
            >
              Connecting
              <br />
              hospitality
            ...
            <motion.p
              variants={fadeUp}
              className="max-w-2xl text-[1.25rem] md:text-[1.5rem] text-white font-medium leading-[1.3] drop-shadow-md"
            >
            ...
            >
              ...
              <a
                href="#"
                className="box-border inline-flex items-center justify-center gap-3 bg-[#0c1420] border border-white/20 rounded-[8px] w-[192px] h-[56px] text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-black shadow-md flex-shrink-0"
              >
                ...
                <div className="text-left">
                  <p className="text-[9px] font-semibold uppercase tracking-wider text-white/80 leading-none">Download on the</p>
              ...
              >
                ...
                <div className="text-left">
                  <p className="text-[9px] font-semibold uppercase tracking-wider text-white/80 leading-none">GET IT ON</p>
