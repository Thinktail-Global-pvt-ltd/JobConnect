        ...
        <div className="min-h-screen pt-20 pb-24 px-6 bg-background overflow-hidden relative">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                >
                    ...
                    <motion.h1
                        variants={fadeUp}
                        className="text-7xl md:text-8xl lg:text-9xl font-display font-light tracking-tight text-white mb-8 leading-[0.9] tracking-[2px]"
                    >
                        The right person.
                        <br />
                    ...
                    >
                        Post a role and let Jobrito's smart matching engine take
                        over. We notify the right talent from our pool — and if
                        they're interested, they reach out to you directly. No
                        searching. No sifting. Just the right fit.
                    </motion.p>
                   <motion.div
  variants={fadeUp}
    ...
    Post a Role
                ...
                >
                    ...
                    <motion.div variants={fadeUp}>
                        ...
                        <div className="w-8 h-px bg-accent mb-6"></div>
                        <div className="text-sm font-sans tracking-wide text-white/50 uppercase">
                            Hospitality professionals across India & the Middle
                            East.
                        </div>
                    </motion.div>
                    <motion.div variants={fadeUp}>
