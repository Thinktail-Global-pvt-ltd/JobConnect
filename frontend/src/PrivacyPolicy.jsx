    ...
    return (
        <div>
            ...
            <div className="mt-28 p-3 text-color-white">
                <h1 className="text-color-white">Privacy Policy</h1>
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            ...
                            access the Service such as a computer, a cell phone
                            or a digital tablet.
                        </p>
                    </li>
                    <li>
                        <p>
                            ...
                            Information&quot;) is any information that relates
                            to an identified or identifiable individual.
                        </p>
                        <p>
                            We use &quot;Personal Data&quot; and &quot;Personal
                            Information&quot; interchangeably unless a law uses
                            a specific term.
                        </p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p>
                            <strong>Website</strong> refers to jobrito,
                            accessible from{" "}
                            <a
                                href="http://jobrito.com/"
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            ...
                            to those that you have already purchased or inquired
                    ...
                    <li>
                        <p>
                            ...
                            Your Personal Data to evaluate or conduct a merger,
                ...
                <ul>
                    <li>
                        ...
                        Your Personal Data with Service Providers to monitor and
                        analyze the use of our Service, to contact You.
                    </li>
                    <li>
                        <strong>For business transfers:</strong> We may share or
                        transfer Your Personal Data in connection with, or
                    ...
                    <li>
                        ...
                        Your Personal Data with Our business partners to offer
                ...
                <p>
                    ...
                    needed for the relevant purpose. We apply different
                    retention periods to different categories of Personal Data
                ...
                <ul>
                    <li>
                        ...
                        <ul>
                            <li>
                                User Accounts: retained for the duration of your
                                account relationship plus up to 24 months after
                                account closure to handle any post-termination
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <p>
                                    Website analytics data (cookies, IP
                                    addresses, device identifiers): up to 24
                                    months from the date of collection, which
                                    allows us to analyze trends while respecting
                                    privacy principles.
                                </p>
                            </li>
                            <li>
                ...
                <ul>
                    <li>
                        Legal obligation: We are required by law to retain
                        specific data (e.g., financial records for tax
                        authorities).
                    </li>
                    <li>
                        Legal claims: Data is necessary to establish, exercise,
                    ...
                    <li>
                        Technical limitations: Data exists in backup systems
                ...
                <ul>
                    <li>
                        Deletion: Personal Data is removed from Our systems and
                        no longer actively processed.
                    </li>
                    <li>
                        Backup retention: Residual copies may remain in
                        encrypted backups for a limited period consistent with
                        our backup retention schedule and are not restored
                        except where necessary for security, disaster recovery,
                        or legal compliance.
                    </li>
                    <li>
                        Anonymization: In some cases, We convert Personal Data
                        into anonymous statistical data that cannot be linked
                        back to You. This anonymized data may be retained
                ...
                <p>
                    ...
                    request access to, correct, or delete any Personal Data that
                ...
                <p>
                    Our Service does not address anyone under the age of 16. We
                    ...
                    age of 16 without verification of parental consent, We take
                ...
                <ul>
                    <li>By email: jobrito@gmail.com</li>
                </ul>
            </div>
            <Footer />
        </div>
