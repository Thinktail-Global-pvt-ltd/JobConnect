  ...
  const handleDeleteAllUsers = async () => {
    ...
    try {
      ...
      if (res && res.data?.success) {
        alert(`Success: ${res.data.message || 'All users, job posts, training programs, sessions, personal access tokens, and notification histories deleted successfully.'}`);
        setUsers([]);
        loadUsers();
      } else {
    ...
    <div className="space-y-3 text-left">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button
          ...
          title="Delete all users, job posts, training programs, sessions, personal access tokens, and notification history from database"
        >
